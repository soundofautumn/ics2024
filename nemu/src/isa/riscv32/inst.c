...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // system
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, mepc = s->pc; mcause = 11; s->dnpc = mtvec; );
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, mepc = s->pc; mcause = 3; s->dnpc = mtvec; );
